...
const DEFAULTS = {
  ...
  // Weekly-ish but not clockwork -- named for what it is ("of the week")
  // while still avoiding the giveaway of landing on the same day every
  // time.
  arg: { minGapDays: 5, maxGapDays: 9 },
};
